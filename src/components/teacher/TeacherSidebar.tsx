    ...
    <aside className="w-full md:w-64 bg-campus-900 text-campus-100 flex flex-col shrink-0">
      ...
      <div className="p-6 border-b border-campus-800 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-campus-800 flex items-center justify-center text-white shadow-xs">
            <Sparkles className="w-5 h-5 text-campus-300" />
          </div>
          <div>
            <div className="font-extrabold text-sm text-campus-100">Teacher Hub</div>
            <div className="text-[10px] text-campus-900 font-bold uppercase">EBAUB Faculty</div>
          </div>
        </Link>
      </div>
      ...
      <nav className="p-4 space-y-1.5 flex-1 text-xs font-semibold">
        {navItems.map(item => {
          ...
          return (
            ...
            >
              <Icon className="w-4 h-4 text-campus-800" />
      ...
      <div className="p-4 border-t border-campus-800 flex items-center justify-between text-xs">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full bg-campus-100 text-campus-900 font-extrabold flex items-center justify-center text-xs">
            T
          </div>
          <div>
            <div className="font-bold text-campus-100">Sabrina Chowdhury</div>
            <div className="text-[10px] text-campus-300">Assistant Professor, CSE</div>
          </div>
        </div>
