      ...
      <table className="w-full text-left text-xs">
        ...
        <tbody className="divide-y divide-slate-100 text-slate-700">
          {materials.map((file, i) => (
            <tr key={file.id || i} className="hover:bg-campus-50/80">
              ...
              <td className="p-4 text-right">
                <button className="px-3 py-1.5 rounded-lg bg-campus-900 hover:bg-campus-800 text-white font-bold text-xs shadow-2xs">
                  Download
                </button>
              </td>
            </tr>
