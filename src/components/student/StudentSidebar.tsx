    ...
    <aside className="w-full md:w-64 bg-campus-950 text-campus-100 flex flex-col shrink-0">
      ...
      <div className="p-6 border-b border-campus-900 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-campus-400 flex items-center justify-center text-campus-950 shadow-xs shrink-0">
            <BookOpen className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <div className="font-extrabold text-sm text-campus-100 truncate">Student Hub</div>
            <div className="text-[10px] text-campus-300 font-bold uppercase truncate">EBAUB Campus</div>
          </div>
        </Link>
      </div>
