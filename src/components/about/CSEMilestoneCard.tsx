...
export default function CSEMilestoneCard() {
  return (
    <div className="bg-gradient-to-br from-campus-950 via-campus-900 to-campus-950 text-white border border-campus-900/80 rounded-3xl p-8 md:p-12 space-y-6 shadow-2xl relative overflow-hidden">
      {/* Corner light source */}
      ...
      <div className="relative z-10 space-y-6">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-campus-900/90 border border-campus-800/80 text-amber-300 text-xs font-bold shadow-sm">
        ...
        <p className="text-sm sm:text-base text-campus-100/90 leading-relaxed font-normal max-w-3xl">
